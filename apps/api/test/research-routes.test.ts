...
describe('anonymous public research contract', () => {
  it('hides expired journal content through overview, fixed-version and presentation-asset routes', async () => {
    ...
    prisma.version.findFirst.mockResolvedValue({ id: 'version-1', publications: [] });
    ...
    try {
      for (const suffix of ['', '/v/1', '/v/1/presentation-assets/55555555-5555-4555-8555-555555555555']) {
