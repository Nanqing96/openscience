...
- 用户报告通过按钮无反应；指定申请仍待审核，旧中文资料不满足英语规则，旧错误位于页尾。已实现逐项英文提示、本行聚焦反馈、处理中/防重、补件说明填入及后台刷新保留结果，待审查/发布/真实观察；未修改申请或后台规则。状态见[期刊 CURRENT](handoff/2026-09-15-journal-onboarding-handoff.md)。
