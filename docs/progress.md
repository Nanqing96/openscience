...
- 2026-09-13图文候选：第二篇私有v5/4266e4ed（RO revision6）已冻结已审SDF和1Claim/40Evidence。现有commit→只整理staging新副本→commit，旧v2/原资料保留。现成导入复用86ffe原图至56e58572，hash不变；审批400暴露generator前缀误判，scene-image最小修复与发布预览内部label替换待部署；应用仍80809452/rollback08ed3b35。无新生成/测试/公开；细节及收据见CURRENT handoff。
