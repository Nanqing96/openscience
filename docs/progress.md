...
- 2026-09-13用户截图反馈：阅读层隐藏Hermes内部[S数字]、去嵌入与旧版/公开媒体制作详情；普通引用/TeX/原文资料保留，公开metadata同步清理编号。当前为候选，生产仍871ed702/rollback80809452；私有v5/revision6、已审内容/图片未改。下一步部署及实际阅读，详见CURRENT handoff。
- 2026-09-13当前：应用871ed702/rollback80809452已部署，必要服务器build/start exit0；High静态PASS，实批同一导入图200。第二篇私有v5/4266e4ed、RO revision6：六项正文逐字等已审SDF，1Claim/40Evidence；唯一approved图56e58572与原86ffe同字节/hash。实际预览10式/0错误、图1280×720、正常图注；桌面/窄屏viewport已看、无横溢出，工作台默认新图/Hermes可输入。旧v2/原图/原来源保留，导入仅通过importRun引用原完整生成记录；未发布，待用户质量确认。无新生成/测试/CI/迁移/依赖；收据/jobs/quantization-version-*，代码修复scene-image误判和ResearchPublication内部label。
