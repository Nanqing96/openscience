...
- 2026-09-13当前应用871ed702/rollback80809452：第二篇已审SDF经现成commit与新副本整理形成私有v5；既有reviewed-media-import复用原图86ffe至56e58572，手工审阅复用后approved，原完整provider/prompt记录仍在旧图，importRun仅引用原资产。修复导入图generator误分类，实际同图审批200/图文预览完整；非自动跨版本继承、非自动科学审校、未公开，无新模型生成或服务。
