# 服务器能力与复用清单
- 2026-09-13候选：现成admin_reviewed_import已复用第二篇图86ffe至私有v5，原字节/hash及原资产完整来源保留。审批400由generator前缀误判引起；scene-image/发布预览label最小修复待部署，无新增服务/依赖/模型调用。当前应用仍80809452/rollback08ed3b35；收据和下一步见CURRENT handoff。
