# 服务器能力与复用清单
- 2026-09-14当前应用e7f95180/rollback0931cf12：公开附件授权及单结论发布修复已部署，服务器完整build/start exit0，独立High PASS，无测试/预检/新服务/模型/依赖/迁移。第二篇真实公开23/v1，DHL、文字/数据CC-BY-4.0、代码MIT，匿名页面/API/PDF200，原PDF568765字节/hash24d11cc8保持；40来源/原图保留。原context.request绕Chrome代理EAI_AGAIN改页面fetch后成功，不是产品登录故障。具体收据与尚未观察范围见CURRENT。
