...
> **CURRENT 2026-09-13:** branch codex/onchip-video-release；应用80809452 / rollback08ed3b35。第二篇已存私有v5/4266e4ed、revision6、已审SDF/1Claim/40Evidence；原图复用至56e58572，审批误判修复待部署，尚未公开。旧v2保留但不得发布。唯一CURRENT handoff见下。
...
| packages/domain/src/assets/scene-image.ts / apps/web/components/research/ResearchPublication.tsx | 区分已审导入与本版分镜生图，发布预览使用用户可读图注 | CANDIDATE；真实导入审批400与修复见CURRENT handoff |
